  ...
  <div class="h-screen flex flex-col">
    ...
    <header class="bg-blue-600 text-white px-6 py-4 shadow-lg">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-blue-200 text-sm">Cloudkoffer 2026 - ClickHouse OLAP Demo</p>
        </div>
    ...
    <footer class="bg-gray-800 text-gray-400 px-6 py-2 text-sm">
      <div class="flex justify-between">
        <span>ClickHouse: cloudkoffer Cluster (4 Replicas)</span>
...
import { fetchFacets, fetchStats, fetchFareDistribution } from './api/clickhouse.js'
